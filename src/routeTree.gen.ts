...
import { Route as PublicPostJobRouteImport } from './routes/_public/post-job'
...
const PublicPostJobRoute = PublicPostJobRouteImport.update({
  id: '/post-job',
  path: '/post-job',
  getParentRoute: () => PublicRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/jobs': typeof PublicJobsRoute
  '/post-job': typeof PublicPostJobRoute
...
export interface FileRoutesById {
  ...
  '/_public/jobs': typeof PublicJobsRoute
  '/_public/post-job': typeof PublicPostJobRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_public/post-job': {
      ...
      path: '/post-job'
      fullPath: '/post-job'
      preLoaderRoute: typeof PublicPostJobRouteImport
      parentRoute: typeof PublicRoute
    }
    '/_public/jobs': {
      id: '/_public/jobs'
...
interface PublicRouteChildren {
  ...
  PublicPostJobRoute: typeof PublicPostJobRoute
  PublicIndexRoute: typeof PublicIndexRoute
}

const PublicRouteChildren: PublicRouteChildren = {
  PublicJobsRoute: PublicJobsRoute,
  PublicPostJobRoute: PublicPostJobRoute,
